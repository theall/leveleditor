...
TProxyStyle::TProxyStyle(const QPalette &palette, QStyle *style)
    : QProxyStyle(style)
    , mPalette(palette)
...
void TProxyStyle::setPalette(const QPalette &palette)
{
    mPalette = palette;
    mIsDark = palette.window().color().value() <= 128;
}

void TProxyStyle::drawPrimitive(PrimitiveElement element,
...
void TProxyStyle::drawControl(ControlElement element,
                                  const QStyleOption *option,
                                  QPainter *painter,
                                  const QWidget *widget) const
{
...
void TProxyStyle::drawComplexControl(ComplexControl control,
...
int TProxyStyle::pixelMetric(QStyle::PixelMetric metric,
                                 const QStyleOption *option,
                                 const QWidget *widget) const
{
    switch (metric) {
...
QSize TProxyStyle::sizeFromContents(ContentsType type,
                                        const QStyleOption *option,
...
QRect TProxyStyle::subElementRect(QStyle::SubElement subElement, const QStyleOption *option, const QWidget *widget) const
{
    QRect r;
...
int TProxyStyle::styleHint(StyleHint styleHint,
                               const QStyleOption *option,
...
QIcon TProxyStyle::standardIcon(QStyle::StandardPixmap standardIcon,
                                    const QStyleOption *option,
                                    const QWidget *widget) const
{
    switch (standardIcon) {
