...
TFlexibleScrollBar::TFlexibleScrollBar(Qt::Orientation orientation, QWidget *parent) :
...
TFlexibleScrollBar::~TFlexibleScrollBar()
{

}

void TFlexibleScrollBar::forceSetValue(int value)
{
    setOverrideRange(std::min(value, minimum()), std::max(value, maximum()));
    setValue(value);
}
...
void TFlexibleScrollBar::sliderChange(QAbstractSlider::SliderChange change)
{
    ...
    case SliderValueChange:
        ...
        setOverrideRange(std::min(mDesiredMinimum, value()), std::max(mDesiredMaximum, value()));
        break;
...
void TFlexibleScrollBar::setOverrideRange(int min, int max)
{
    mOverrideMinimum = min;
    mOverrideMaximum = max;
